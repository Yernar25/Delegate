...
class ModalTableViewController: UITableViewController, AddListProtocol {
    ...
    @IBAction func openAddView(_ sender: Any) {
        let modalView = storyboard?.instantiateViewController(withIdentifier: "AddViewController") as! ViewController
